                        ...
                        <table class="table align-middle mb-0 table-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a
                                                href="{{ url('ecommerce-product-detail') }}" class="text-dark">Half sleeve
                                                T-shirt</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a
                                                href="{{ url('ecommerce-product-detail') }}" class="text-dark">Light blue
                                                T-shirt</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a
                                                href="{{ url('ecommerce-product-detail') }}" class="text-dark">Black Color
                                                T-shirt</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a
                                                href="{{ url('ecommerce-product-detail') }}" class="text-dark">Hoodie
                                                (Blue)</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a
                                                href="{{ url('ecommerce-product-detail') }}" class="text-dark">Green
                                                color
                                                T-shirt</a></h5>
